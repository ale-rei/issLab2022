...
@Actor22(name = ApplData.robotName, contextName = "ctx", implement = V3WalkerFsm.class)
public  class V3MainWalkerFsm {
	public V3MainWalkerFsm(   ) {
