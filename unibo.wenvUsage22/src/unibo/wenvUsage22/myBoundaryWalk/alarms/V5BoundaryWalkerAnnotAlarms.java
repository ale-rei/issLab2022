...
import unibo.wenvUsage22.myBoundaryWalk.fsmAnnot.WsConnWEnvObserver;

public class V5BoundaryWalkerAnnotAlarms extends QakActor22FsmAnnot  {
	private Interaction2021 conn;	
 	private int ncorner  = 0;
 	boolean wotkInterrupted = false;
 	String currentMove = "none";
 	
	public V5BoundaryWalkerAnnotAlarms(String name) {
		super(name);
